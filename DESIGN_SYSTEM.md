# Padrão Visual — Portal Fornecepro

Guia de referência para construção de telas funcionais, elegantes e profissionais.

> Princípios: limpo · simples · funcional · encantador
> "Menos bordas, mais respiro. Hover sutil, não dramático."

---

## 1. Estrutura de página (layout base)

Toda tela principal segue:
